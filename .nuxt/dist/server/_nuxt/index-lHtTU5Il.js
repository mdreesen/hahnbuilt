import { _ as __nuxt_component_0$1 } from "./Header-BMeOThra.js";
import { _ as __nuxt_component_1$1, a as __nuxt_component_0$2 } from "./HeaderSection-DXW7-xnc.js";
import { resolveDirective, mergeProps, useSSRContext, defineComponent, ref, unref } from "vue";
...
import { _ as _export_sfc, b as useSeoMeta, u as useHead } from "../server.mjs";
import { _ as __nuxt_component_1$2 } from "./Card-BTmRR024.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><p${ssrRenderAttrs(mergeProps({ class: "mt-10 max-w-xl text-zinc-400 font-medium leading-relaxed text-lg" }, ssrGetDirectiveProps(_ctx, _directive_gsap, { opacity: 0, x: -50, duration: 1, delay: 0.8 }, void 0, { from: true })))}> Advanced concrete solutions for residential and commercial developments. At Hahn Built, we bridge the gap between architectural vision and structural permanence. </p></div><div${ssrRenderAttrs(mergeProps({ class: "absolute right-0 top-0 w-1/2 h-full grayscale opacity-40" }, ssrGetDirectiveProps(_ctx, _directive_gsap, {
    scrollTrigger: {
      trigger: "section",
      start: "top top",
      scrub: true
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(projects, (project, index) => {
        ...
        _push(`<div class="absolute inset-0 p-12 flex flex-col justify-end bg-linear-to-t from-black/90 to-transparent"><span class="text-orange-500 font-mono text-sm mb-3 uppercase tracking-widest">${ssrInterpolate(project.type)}</span><h3 class="text-5xl font-extrabold uppercase italic">${ssrInterpolate(project.title)}</h3></div></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
//# sourceMappingURL=index-lHtTU5Il.js.map
