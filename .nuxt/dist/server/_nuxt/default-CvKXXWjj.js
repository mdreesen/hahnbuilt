...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<p class="text-zinc-400 max-w-sm mb-8 leading-relaxed"> Specializing in high-performance concrete structures across the Flathead Valley. From Evergreen to the peaks, we build the bedrock of Montana. </p><div class="flex flex-col gap-2 font-mono text-xs uppercase tracking-widest text-orange-600"><span>Evergreen, Montana</span><span>Licensed • Bonded • Insured</span></div></div><div class="md:col-span-2"><h4 class="text-xs font-black uppercase tracking-[0.2em] mb-8 text-zinc-300">Navigation</h4><ul class="flex flex-col gap-4 text-sm font-bold uppercase italic tracking-tight"><li>`);
