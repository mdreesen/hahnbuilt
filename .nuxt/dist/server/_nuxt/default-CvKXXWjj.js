import { e as __nuxt_component_0$1, a as __nuxt_component_0$2, _ as _export_sfc, f as useRoute, u as useHead } from "../server.mjs";
...
import { a as __nuxt_component_0$3, _ as __nuxt_component_1$1 } from "./HeaderSection-DXW7-xnc.js";
...
const __nuxt_component_2 = Object.assign(_sfc_main$2, { __name: "BaseLink" });
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_baseHeaderSection = __nuxt_component_0$3;
  const _component_baseImage = __nuxt_component_1$1;
  const _component_baseLink = __nuxt_component_2;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-[#0c0c0c] text-white pt-32 pb-10 px-10 border-t border-white/5 relative overflow-hidden" }, _attrs))}><div class="absolute bottom-0 left-0 right-0 select-none pointer-events-none translate-y-1/4">`);
  _push(ssrRenderComponent(_component_baseHeaderSection, { text: "Hahn Built" }, null, _parent));
  _push(`</div><div class="max-w-7xl mx-auto relative z-10"><div class="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24"><div class="md:col-span-5">`);
  _push(ssrRenderComponent(_component_baseImage, {
    source: "/images/logo_transparent.webp",
    style: "w-48 mb-8",
    alt: "Hahn Built transparent logo"
  }, null, _parent));
  _push(`<p class="text-zinc-500 max-w-sm mb-8 leading-relaxed"> Specializing in high-performance concrete structures across the Flathead Valley. From Evergreen to the peaks, we build the bedrock of Montana. </p><div class="flex flex-col gap-2 font-mono text-xs uppercase tracking-widest text-orange-600"><span>Evergreen, Montana</span><span>Licensed • Bonded • Insured</span></div></div><div class="md:col-span-2"><h4 class="text-xs font-black uppercase tracking-[0.2em] mb-8 text-zinc-300">Navigation</h4><ul class="flex flex-col gap-4 text-sm font-bold uppercase italic tracking-tight"><li>`);
...
//# sourceMappingURL=default-CvKXXWjj.js.map
