...
const styles = {
  "pages/projects.vue": () => import('./projects-styles.DnjjjMDc.mjs').then(interopDefault),
  "pages/projects.vue?vue&type=style&index=0&scoped=a3a8a666&lang.css": () => import('./projects-styles.DnjjjMDc.mjs').then(interopDefault),
