...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-24 px-6 md:px-12 border-t border-zinc-800" }, _attrs))} data-v-24b6f227><header class="mb-20" data-v-24b6f227>`);
      ...
      _push(`</header><div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-8 space-y-8" data-v-24b6f227><!--[-->`);
      ssrRenderList(projects, (project) => {
        _push(`<div class="break-inside-avoid group relative overflow-hidden bg-zinc-900 border border-zinc-800 rounded-sm shadow-xl transition-all duration-300 hover:border-orange-600/30 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-600/5" data-v-24b6f227><div class="${ssrRenderClass([
        ...
        _push(`<div class="absolute inset-0 bg-linear-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8" data-v-24b6f227><span class="text-orange-500 font-mono text-xs uppercase tracking-widest mb-2" data-v-24b6f227>Hahn Built Verified</span></div> 1/div&gt; <div class="p-5 flex justify-between items-center bg-zinc-900 border-t border-zinc-800" data-v-24b6f227><span class="font-bold text-xs uppercase tracking-[0.2em] text-zinc-400 group-hover:text-white transition-colors duration-300" data-v-24b6f227>${ssrInterpolate(project.title)}</span><div class="w-8 h-0.5 bg-zinc-700 group-hover:w-16 group-hover:bg-orange-600 transition-all duration-300" data-v-24b6f227></div></div></div></div>`);
      });
      _push(`<!--]--></div></section>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-24b6f227"]]);

export { index as default };
//# sourceMappingURL=index-BJHT2CKk.mjs.map
