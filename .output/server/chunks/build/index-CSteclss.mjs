  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(projects, (project) => {
        _push(`<div class="break-inside-avoid group relative overflow-hidden bg-zinc-900 border border-zinc-800 rounded-sm shadow-xl transition-all duration-300 hover:border-orange-600/30 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-600/5" data-v-b0710d43><div class="${ssrRenderClass([
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b0710d43"]]);

export { index as default };
//# sourceMappingURL=index-CSteclss.mjs.map
