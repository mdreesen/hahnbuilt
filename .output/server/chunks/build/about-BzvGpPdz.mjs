...
import { _ as __nuxt_component_1 } from './Description-CR3Na8no.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_baseDescription, { text: "In Montana, the environment is the ultimate inspector. At Hahn Built, we don't just pour\n                        concrete; we engineer foundations that withstand the shifting frost and heavy loads of the\n                        Flathead Valley." }, null, _parent));
      _push(`</div><div${ssrRenderAttrs(mergeProps({ class: "relative aspect-square bg-zinc-900 overflow-hidden group" }, ssrGetDirectiveProps(_ctx, _directive_gsap, { opacity: 0, scale: 0.9, duration: 1.5 }, void 0, { from: true })))}>`);
      ...
      _push(`<!--]--></section><section class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end"><div class="lg:col-span-4"><h2 class="text-4xl font-black uppercase italic tracking-tight mb-6">Our Bedrock</h2>`);
      ...
      ssrRenderList(qualityPoints, (point, i) => {
        _push(`<div${ssrRenderAttrs(mergeProps({
          ...
          opacity: 0,
          delay: i * 0.2
        }, void 0, { from: true })))}><div class="text-orange-600 font-mono text-lg pt-1">/0${ssrInterpolate(i + 1)}</div><div><h4 class="text-xl font-black uppercase italic tracking-tight mb-2 group-hover:text-orange-600 transition-colors">${ssrInterpolate(point.title)}</h4>`);
...
//# sourceMappingURL=about-BzvGpPdz.mjs.map
