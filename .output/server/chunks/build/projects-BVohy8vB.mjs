import { _ as _plugin_vue_export_helper_default, u as useSeoMeta$1, N as NuxtLink } from '../virtual/entry.mjs';
...
//#region app/pages/projects/index.vue?vue&type=script&setup=true&lang.ts
				...
				_push(ssrRenderComponent(_component_nuxt_link, { to: project.href }, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<div class="grid grid-cols-1 md:grid-cols-12 items-center gap-8" data-v-7dd3822c${_scopeId}><div class="md:col-span-1 font-mono text-zinc-400 group-hover:text-orange-600 transition-colors" data-v-7dd3822c${_scopeId}>${ssrInterpolate(project.id)}</div><div class="md:col-span-5" data-v-7dd3822c${_scopeId}><span class="text-4xl md:text-6xl font-black uppercase italic tracking-tighter group-hover:translate-x-4 transition-transform duration-500" data-v-7dd3822c${_scopeId}>${ssrInterpolate(project.title)}</span></div><div class="md:col-span-3 text-right hidden md:block" data-v-7dd3822c${_scopeId}></div></div>`);
							...
							createVNode("div", { class: "md:col-span-5" }, [createVNode("span", { class: "text-4xl md:text-6xl font-black uppercase italic tracking-tighter group-hover:translate-x-4 transition-transform duration-500" }, toDisplayString(project.title), 1)]),
...
//#endregion
//#region app/pages/projects/index.vue
...
var projects_default = /*#__PURE__*/ _plugin_vue_export_helper_default(index_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-7dd3822c"]]);

export { projects_default as default };
//# sourceMappingURL=projects-BVohy8vB.mjs.map
