...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="text-sm text-zinc-400 mt-2 font-mono uppercase">Mon — Fri / 07:00 — 17:00</p></div></div><div class="p-10 border border-white/5 bg-zinc-900/10 mt-20"><h5 class="text-xs font-black uppercase tracking-widest mb-4">Structural Inspection</h5>`);
