...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="absolute inset-0 bg-orange-600 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"></div></button></div></div></div><div class="lg:col-span-5 flex flex-col justify-between py-6"><div class="space-y-16"><div><h4 class="text-orange-600 font-mono text-[10px] uppercase tracking-[0.3em] mb-6">Headquarters</h4><p class="text-3xl font-bold uppercase italic leading-tight"> Kalispell, Montana<br> Flathead Valley </p>`);
      _push(ssrRenderComponent(_component_baseDescription, { text: "Kalispell, Montana<br />\n                Flathead Valley" }, null, _parent));
      _push(`</div><div><h4 class="text-orange-600 font-mono text-[10px] uppercase tracking-[0.3em] mb-6">Direct Line</h4><p class="text-3xl font-bold uppercase italic leading-tight hover:text-orange-600 transition-colors"><a href="tel:4063002052">(406) 300-2052</a></p>`);
      _push(ssrRenderComponent(_component_baseDescription, { text: `<a href='tel:4063002052'>(406) 300-2052</a>` }, null, _parent));
      _push(`<p class="text-sm text-zinc-500 mt-2 font-mono uppercase">Mon — Fri / 07:00 — 17:00</p></div></div><div class="p-10 border border-white/5 bg-zinc-900/10 mt-20"><h5 class="text-xs font-black uppercase tracking-widest mb-4">Structural Inspection</h5>`);
      _push(ssrRenderComponent(_component_baseDescription, { text: "All project manifests are reviewed by our lead engineers. Response time is typically within 24 operational\n              hours." }, null, _parent));
...
//# sourceMappingURL=contact-ClSCPCHZ.mjs.map
